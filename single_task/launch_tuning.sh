...
while true; do
  ...
  case "$1" in
    --job_name ) JOB_NAME="$2"; echo $JOB_NAME; shift; shift ;;
    --config ) CONFIG="$2"; echo $CONFIG; shift; shift ;;
    --num_tuners ) NUM_TUNERS="$2"; echo $NUM_TUNERS; shift; shift ;;
    --num_workers_per_tuner ) NUM_WORKERS_PER_TUNER="$2"; echo $NUM_WORKERS_PER_TUNER; shift; shift ;;
    --num_ps_per_tuner ) NUM_PS_PER_TUNER="$2"; echo $NUM_PS_PER_TUNER; shift; shift ;;
    --max_npe ) MAX_NPE="$2"; echo $MAX_NPE; shift; shift ;;
    --num_repetitions ) NUM_REPETITIONS="$2"; echo $NUM_REPETITIONS; shift; shift ;;
    --stop_on_success ) STOP_ON_SUCCESS="$2"; echo $STOP_ON_SUCCESS; shift; shift ;;
    --fixed_hparams ) FIXED_HPARAMS="$2"; echo $FIXED_HPARAMS; shift; shift ;;
    --hparam_space_type ) HPARAM_SPACE_TYPE="$2"; echo $HPARAM_SPACE_TYPE; shift; shift ;;
    -- ) shift; break ;;
    * ) break ;;
  esac
done
