...
def make_task(task_name, override_kwargs=None, max_code_length=200,
  ...
  task_mapping = {
      ...
      'sort3': (SortFixedTask, dict(base=27, length=3)),
      'sort0': (SortFixedTaskV0, dict(base=27, length=3)),
...
#         unsorted = []
#         for _ in range(i):
#             unsorted.append(random.randrange(20))
#         sorted = unsorted[:].sort()
#         outputs.append((unsorted, sorted))
#     return outputs
...
class SortFixedTaskV0(BaseTask):
  """Sort list coding task.
